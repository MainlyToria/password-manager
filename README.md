...
SecurePass is a desktop password manager (Tkinter) that stores an encrypted JSON vault.
...
- `securepass/crypto.py` — key derivation and (Fernet) encryption helpers.
- `securepass/storage.py` — encrypted JSON vault save/load and upgrade path.
- `securepass/app.py` — Tkinter GUI, search, edit, auto-lock, plotting and export features.
