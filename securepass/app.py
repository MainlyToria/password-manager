"""Tkinter desktop application for SecurePass.
...
class SecurePassApp:
    """Main Tkinter application class for the SecurePass desktop UI.
    ...
    def _build_login(self):
        self.clear_root()
        Label(self.root, text="SecurePass — Enter Master Password").pack(pady=10)
    ...
    def _build_main(self):
        ...
        self.clear_root()
        Label(self.root, text="SecurePass — Vault").pack()
        # Search box
